...
public:
    ...
    void setupUi(QDialog *RegWindow)
    {
        ...
        line->setGeometry(QRect(80, 410, 341, 2));
        ...
        closeEye->setGeometry(QRect(370, 195, 35, 35));
...
"}"));
        ...
        authLink->setGeometry(QRect(80, 420, 111, 29));
        QFont font;
...
"QPushButton:hover { color: #9932CC; text-decoration: underline; }"));
        ...
        textLogin->setGeometry(QRect(79, 120, 341, 45));
        QFont font1;
...
"}"));
        ...
        regButton->setGeometry(QRect(80, 330, 341, 60));
        QFont font2;
...
"}"));
        ...
        textPhone->setGeometry(QRect(80, 260, 341, 45));
...
"}"));
        ...
        textPassword->setGeometry(QRect(80, 190, 341, 45));
...
"}"));
        ...
        openEye->setGeometry(QRect(370, 195, 35, 35));
...
"}"));
        ...
        regLabel->setGeometry(QRect(160, 40, 220, 50));
        QFont font3;
