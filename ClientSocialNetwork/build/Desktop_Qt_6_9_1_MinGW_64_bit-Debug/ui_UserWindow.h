...
public:
    ...
    void setupUi(QDialog *UserWindow)
    {
        ...
        UserWindow->resize(625, 660);
        UserWindow->setMinimumSize(QSize(625, 660));
        UserWindow->setMaximumSize(QSize(625, 660));
        UserWindow->setStyleSheet(QString::fromUtf8("background-color: rgb(248, 249, 255);"));
        usersList = new QListWidget(UserWindow);
...
"	background: none;\n"
"}"));
        searchText = new QLineEdit(UserWindow);
...
"}"));
        ...
        countFriendsLabel = new QLabel(UserWindow);
        ...
        allUsersButton = new QPushButton(UserWindow);
...
"}"));
        searchButton = new QPushButton(UserWindow);
...
"    );\n"
"}"));
        friendsButton = new QPushButton(UserWindow);
...
"}"));
    ...
    void retranslateUi(QDialog *UserWindow)
    {
        ...
        searchText->setPlaceholderText(QCoreApplication::translate("UserWindow", "\320\237\320\276\320\270\321\201\320\272 \320\277\320\276 \320\273\320\276\320\263\320\270\320\275\321\203", nullptr));
        countFriendsLabel->setText(QString());
        allUsersButton->setText(QCoreApplication::translate("UserWindow", "\320\222\321\201\320\265 \320\277\320\276\320\273\321\214\320\267\320\276\320\262\320\260\321\202\320\265\320\273\320\270", nullptr));
        searchButton->setText(QCoreApplication::translate("UserWindow", "\320\235\320\260\320\271\321\202\320\270", nullptr));
        friendsButton->setText(QCoreApplication::translate("UserWindow", "\320\234\320\276\320\270 \320\264\321\200\321\203\320\267\321\214\321\217", nullptr));
    } // retranslateUi
