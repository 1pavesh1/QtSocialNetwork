...
template <> constexpr inline auto FeedWindow::qt_create_metaobjectdata<qt_meta_tag_ZN10FeedWindowE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SlotData<void(const UserModel &)>(10, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 11, 12 },
        }}),
        // Slot 'OnLikeClicked'
        QtMocHelpers::SlotData<void(const PostModel &)>(13, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 14, 15 },
        }}),
        // Slot 'OnCommentClicked'
        QtMocHelpers::SlotData<void(const PostModel &)>(16, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 14, 15 },
        }}),
        // Slot 'OnEditComment'
        QtMocHelpers::SlotData<void(const CommentModel &)>(17, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 18, 19 },
        }}),
        // Slot 'OnDeleteComment'
        QtMocHelpers::SlotData<void(const CommentModel &)>(20, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 18, 19 },
        }}),
...
void FeedWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->on_usersPinButton_clicked(); break;
        case 3: _t->on_settingsPinButton_clicked(); break;
        case 4: _t->on_exitPinButton_clicked(); break;
        case 5: _t->on_addPostButton_clicked(); break;
        case 6: _t->on_notificationButton_clicked(); break;
        case 7: _t->on_searchButton_clicked(); break;
        case 8: _t->OnAvatarClicked((*reinterpret_cast< std::add_pointer_t<UserModel>>(_a[1]))); break;
