...
template <> constexpr inline auto AuthWindow::qt_create_metaobjectdata<qt_meta_tag_ZN10AuthWindowE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "UserModel",
        "userModel",
        "HandleUserAuthServer",
        "HandleUserAuthFailed",
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'HandleUserAuthServer'
        QtMocHelpers::SlotData<void()>(5, 2, QMC::AccessPublic, QMetaType::Void),
        // Slot 'HandleUserAuthFailed'
...
void AuthWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->HandleUserAuth((*reinterpret_cast< std::add_pointer_t<UserModel>>(_a[1]))); break;
        case 1: _t->HandleUserAuthServer(); break;
        case 2: _t->HandleUserAuthFailed(); break;
        ...
        case 5: _t->on_regLink_clicked(); break;
        case 6: _t->on_authButton_clicked(); break;
        default: ;
        }
    }
