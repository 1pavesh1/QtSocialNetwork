...
"}"));
        ...
        authLabel->setGeometry(QRect(160, 60, 220, 45));
        QFont font1;
        ...
        passwordLink->setGeometry(QRect(320, 410, 131, 29));
        QFont font2;
...
"QPushButton:hover { color: #9932CC; text-decoration: underline; }"));
        ...
        authButton->setGeometry(QRect(80, 320, 341, 60));
        QFont font3;
...
"}"));
        ...
        textPassword->setGeometry(QRect(79, 180, 341, 45));
        QFont font4;
...
"}"));
        ...
        regLink->setGeometry(QRect(80, 410, 111, 29));
